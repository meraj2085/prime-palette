      ...
      <div className="relative">
        ...
        <div className="absolute top-1/2 md:top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center md:left-[800px] md:text-left md:transform-none">
          <div>
            ...
            <h1 className="text-2xl md:ms-7">Paintings For Home</h1>
          </div>
          <div className="mt-10 space-y-3 text-xs text-gray-600 md:mt-5 md:flex md:flex-row md:justify-center md:space-x-8 md:space-y-0">
